!function (t, e) {
    ...
    var lt = l({}, st, {
        code: "EPSG:3857", projection: rt, transformation: ht(lt = .5 / (Math.PI * rt.R), .5, -lt, .5)
    ...
    var mt = {
        ...
        _handleGeolocationError: function (t) {
            ...
            this._container._leaflet_id && (e = t.code, t = t.message || (1 === e ? "permission denied" : 2 === e ? "position unavailable" : "timeout"), this._locateOptions.setView && !this._loaded && this.fitWorld(), this.fire("locationerror", {
                code: e, message: "Geolocation error: " + t + "."
            }))
        },
    ...
    var B = et.extend({
        ...
        options: {clickTolerance: 3}, initialize: function (t, e, i, n) {
            ...
            this._moving = !1, Xe._dragging = !1, e && this.fire("dragend", {
                noInertia: t, distance: this._newPos.distanceTo(this._startPos)
            })
        }
    });
    ...
    var vt = {
            ...
            code: "EPSG:3395", projection: xt, transformation: ht(bt = .5 / (Math.PI * xt.R), .5, -bt, .5)
        ...
        o = (ot.Earth = st, ot.EPSG3395 = Pt, ot.EPSG3857 = lt, ot.EPSG900913 = ut, ot.EPSG4326 = li, ot.Simple = Lt, it.extend({
            ...
            addLayer: function (t) {
                ...
                const zoomSpanBefore = this._getZoomSpan();

                for (let layerId in this._zoomBoundLayers) {
                    const layerOptions = this._zoomBoundLayers[layerId].options;
                    minZoom = (layerOptions.minZoom !== undefined) ? Math.min(minZoom, layerOptions.minZoom) : minZoom;
                    maxZoom = (layerOptions.maxZoom !== undefined) ? Math.max(maxZoom, layerOptions.maxZoom) : maxZoom;
                }

                this._layersMaxZoom = (maxZoom === -Infinity) ? undefined : maxZoom;
                this._layersMinZoom = (minZoom === Infinity) ? undefined : minZoom;

                const zoomSpanAfter = this._getZoomSpan();

                if (zoomSpanBefore !== zoomSpanAfter) {
    ...
    var _i = di.extend({
        ...
        options: {
            ...
            i && (t = (e = this.options.icon.options).iconSize ? m(e.iconSize) : m(0, 0), e = e.iconAnchor ? m(e.iconAnchor) : m(0, 0), i.panInside(this._latlng, {
                paddingTopLeft: e, paddingBottomRight: t.subtract(e)
            }))
    ...
    var _t = n.extend({
            ...
            tapHold: b.touchNative && b.safari && b.mobile, tapTolerance: 15
        }), n.extend({
            addHooks: function () {
            ...
            touchZoom: b.touch, bounceAtZoomLimits: !0
        }), n.extend({
            addHooks: function () {
